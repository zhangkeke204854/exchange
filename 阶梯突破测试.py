...
def initialize(context):
    SetBarInterval(g_params['contractNo'], g_params['barType'], g_params['barInterval'], 1000, 50)  # 订阅历史K线
...
def handle_data(context):
    ...
    if context.triggerType() != "K" and context.triggerType() != "H":
        return
    if CurrentBar(g_params['contractNo'], g_params['barType'], g_params['barInterval']) < 3:
        return
